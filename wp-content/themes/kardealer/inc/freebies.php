...
echo '<div id="kardealer-freebies-page">';
...
<div id="freebies-tab">
    ...
    <div class="freebies-row">
    <?php echo  '<img class="freebies-tab-icon" alt="aux" src="'.get_template_directory_uri().'/images/download-2.png"  />';?>
    <a class="freebies-tab-link" href="https://wordpress.org/plugins/multidealer/">Multi Dealer Plugin</a>
    </div>
    ...
    <div class="freebies-row">
    <?php echo  '<img class="freebies-tab-icon" alt="aux" src="'.get_template_directory_uri().'/images/download-2.png"  />';?>
    <a class="freebies-tab-link" href="https://wordpress.org/plugins/cardealer/">Car Dealer Plugin</a>
    </div>


    <div class="freebies-row">
    <?php echo  '<img class="freebies-tab-icon" alt="aux" src="'.get_template_directory_uri().'/images/download-2.png"  />';?>
    <a class="freebies-tab-link" href="https://wordpress.org/plugins/real-estate-right-now/">Real Estate Plugin</a>
    </div>
    ...
    <div class="freebies-row"> 
    <?php echo  '<img class="freebies-tab-icon" alt="aux" src="'.get_template_directory_uri().'/images/download-2.png"  />';?>
    <a class="freebies-tab-link" href="https://wordpress.org/themes/boatdealer/">Theme Boat Dealer</a>
    </div>   
