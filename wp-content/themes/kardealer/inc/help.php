...
function kardealer_enqueue_scripts() {
    	...
    	wp_enqueue_script( 'fix-config-manager' );
      	...
      	wp_enqueue_style( 'kardealertheme-feedback' , kardealerURL.'/css/feedback-plugin.css');
    	wp_register_script( 'kardealertheme-lib',kardealerURL.'/js/kardealertheme-lib.js' , array( 'jquery' ), kardealerVERSION );
		wp_enqueue_script( 'kardealertheme-lib' );
        wp_register_style( 'kardealertheme-lib-css',kardealerURL.'/css/kardealertheme-lib.css', array(), '20170404');
        wp_enqueue_style( 'kardealertheme-lib-css' );
}
