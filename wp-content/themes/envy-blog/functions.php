...
/**
    ...
    add_action( 'add_meta_boxes', 'addCarParentMetabox' ); 

function addCarParentMetabox() {
 
    add_meta_box( 'car_parent', 'Car', 'renderStaffParentMetabox' , 'lead' );
...
function renderStaffParentMetabox($post) {
    ...
    echo 'Customer interested in ';
    echo '<select name="staff_parent">';
    echo '<option value="">Choose a car...</option>';
...
$controller->route([ 'slug' => 'Single:lead', 'controller' => 'Lead' ]);