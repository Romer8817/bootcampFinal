...
// Header Settings
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> 'header_settings_section',
			'type'			=> 'checkbox',
			'label'			=> __( 'Show border', 'kardealer' ),
			'description'	=> '',
//			)
		)
	);    
...
function kardealer_color_scheme_css() {
	$color_scheme_option = get_theme_mod(get_theme_mod( 'color_scheme', 'default' ));
...
function kardealer_page_background_color_css() {
	...
	$page_background_color = get_theme_mod(get_theme_mod( 'page_background_color', $default_color ));
...
function kardealer_link_color_css() {
	...
	$link_color = get_theme_mod(get_theme_mod( 'link_color', $default_color ));
	// Don't do anything if the current color is the default.
...
function kardealer_secondary_text_color_css() {
	...
	$secondary_text_color = get_theme_mod(get_theme_mod( 'secondary_text_color', $default_color ));
	// Don't do anything if the current color is the default.
...
function kardealer_dynamic_css() { ?>
 <style type='text/css'>
    .entry-title
     { 
     <?php
     $kardealer_entry_title = esc_html(get_theme_mod(get_theme_mod('kardealer_entry_title',1))); 
...
.social-navigation a {
   ...
   #header_top_left, #kardealer_topinfo_text a 
   {
	...
	.main-navigation {
        ...
        <?php $mymenubackground = esc_html(get_theme_mod('kardealer_navigation_background', '#e65e23'));?> 
	}
    .site-header-menu
    {
...
<?php
   ...
   $kardealer_header_background_color = esc_html(get_theme_mod('kardealer_header_background_color','#ffffff'));     
   ...
   $kardealer_header_text_color = esc_html(get_theme_mod('kardealer_header_text_color','#000000'));     
   $kardealer_header_cart_color = esc_html(get_theme_mod('kardealer_header_cart_color','#000000'));     
   echo '.site-header {';
   if($kardealer_header_border == '1' )
   {
    ...
    echo '}';  
    echo '.site-title a, .site-description {';
    echo 'background: '.$kardealer_header_background_color. '!important;';
    echo 'color: '.$kardealer_header_text_color. '!important;';
    echo '}';    
